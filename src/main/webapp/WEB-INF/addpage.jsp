...
<table align="center">
<tr>
	<td><h3 style="font-size:20px;">Drug ID</h3></td>
...
<tr>
	<td><h3 style="font-size:20px;">Drug Quantity</h3></td>
	<td><input type="text" name="quantity"></td>
</tr>

<tr>
	<td><h3 style="font-size:20px;">Drug Price</h3></td>
	<td><input type="text" name="price"></td>
</tr>

<tr>
	<td><h3 style="font-size:20px;">Drug Description</h3></td>
